 ...
 */
@Data
@Schema(description = "新增笔记请求")
public class AinoteNoteCreateDTO implements Serializable {
    ...
    @Size(max = 65535, message = "笔记内容长度不能超过65535")
    @Schema(description = "笔记内容（Markdown格式）")
    private String noteContent;

    @Size(max = 200, message = "AI摘要长度不能超过200")
    @Schema(description = "AI生成的摘要")
    private String aiSummary;

    @Size(max = 500, message = "关键词长度不能超过500")
    @Schema(description = "关键词（逗号分隔，最多5个）")
