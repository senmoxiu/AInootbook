    ...
    <div class="modal">
      <div class="tool-edit-content">
        ...
        <div class="section">
          ...
          <a-table :dataSource="requestParams" :columns="requestParamsColumns" :pagination="false" bordered size="small" rowKey="tempId">
            <template #bodyCell="{ column, record, index }">
              <template v-if="column.key === 'name'">
                <a-input v-model:value="record.name" placeholder="参数名称（字母数字下划线）" @blur="validateParamName(record)" />
              </template>
        ...
        <div class="section">
          ...
          <a-table :dataSource="responseParams" :columns="responseParamsColumns" :pagination="false" bordered size="small" rowKey="tempId">
            <template #bodyCell="{ column, record, index }">
              <template v-if="column.key === 'name'">
                <a-input
