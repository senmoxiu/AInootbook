...
<script setup lang="ts">
  ...
  import ImageViewer from '@/views/super/airag/shared/chat/components/ImageViewer.vue';
  import { useAppInject } from '@/hooks/web/useAppInject';
  import { useGlobSetting } from '@/hooks/setting';
  import { mdPluginJeecgTag, JEECG_TAG_CLASS, jeecgTagMap } from './jeecg-tags';
  import knowledgePng from '@/views/super/airag/aiknowledge/icon/knowledge.png';
