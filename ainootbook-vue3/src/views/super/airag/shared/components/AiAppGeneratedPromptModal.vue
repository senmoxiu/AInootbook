...
<script lang="ts">
  ...
  import { promptGenerate } from '@/views/super/airag/aiprompts/AiragPrompts.api';
  import AiAppPromptMarketModal from '@/views/super/airag/shared/components/AiAppPromptMarketModal.vue';
